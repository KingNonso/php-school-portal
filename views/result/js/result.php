    ...
    <div class="row" id="container">
        ...
        <div class="col-sm-10 col-sm-offset-1 register-box-body">
            <div class="col-sm-12 text-center">
                ...
                <p>Email address: info@bsso.org.ng</p>

                <hr>
                <h3><b> Statement of Result</b></h3>
                <h4><?php echo Session::flash('result_term'); ?> Term <?php echo Session::flash('result_session'); ?> Academic Session </h4>
                <hr>
            </div>
            <div class="row">
                ...
                <div class="col-sm-6 text-right" id="img_holder">
                    <div class="imgholder"><img src="<?php echo(URL) ?>public/images/oraifiteboys.fw.png" alt="" class="img-thumbnail" width="150" height="150" /></div>
                </div>
            ...
            <div class="col-sm-6 table-responsive" id="moral_score">
                <table class="table table-bordered">
                    <tr>
                        <th>Affective <small>Assessment</small></th>
                        <td>1</td>
                        <td>2</td>
                        <td>3</td>
                        <td>4</td>
            ...
            <div class="col-sm-6" id="principal_sign">
                <p>Form Teacher Comment: </p>
                <br/>
                <hr>
                <p>Form Teacher Sign</p>
                <hr>
                <hr>
