            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-12 col-xs-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form action="<?php echo(URL.'admin/add_event/'.$mod['id']); ?>" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="show_academic" id="show_academic">
                                        ...
                                        <?php foreach ($this->academics as $class){ ?>
                                            <option value="<?php echo $class['session_id']; ?>" <?php if ($mod['session_id'] == $class['session_id'] ){echo "selected=\"selected\"";} ?> ><?php echo $class['session_name'].' '.$class['term'] ; ?> term</option>
                                        <?php }  ?>
                                    </select>
