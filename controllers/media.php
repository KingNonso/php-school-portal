...
class Media extends Controller {
    ...
    function index(){
        ...
        $this->view->title = "School Calender and Events";
        $this->view->event = $this->model->get_event();
        $model = $this->reMapRouteToModel('blog');

        $this->view->latest10 = $this->blog->get_all_blog_titles(false, 3);

        $this->view->render('index/media');
    }
