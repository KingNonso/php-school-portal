                                    ...
                                    <?php
                                        ...
                                        foreach($this->adviser as $mod){
                                            ...
                                            <tr>
                                                ...
                                                <td> <a href="<?php echo URL; ?>admin/adviser/class/<?php echo $mod['person_id']; ?>" class="btn btn-info btn-flat">Assign Class</a></td>

                                                <td> <a href="<?php echo URL; ?>admin/adviser/delete/<?php echo $mod['adviser_id']; ?>" class="btn btn-danger btn-flat">Remove</a></td>
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form role="form" action="<?php echo(URL.'admin/adviser'); ?>" method="post" id="contact_form">
                            <div class="box-body">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">THE Adviser Planner</h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        <div class="box-body">
                ...
                <div class="col-md-9 col-sm-12 col-xs-12">
                    ...
                    <div class="box box-primary">
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form action="<?php echo(URL.'admin/add_adviser'); ?>" method="post" id="contact_form" enctype="multipart/form-data">
                                ...
                                <p>
                                    <?php
                                        if(isset($this->detail)){
                                            echo("<br/>Advisor Details: <br/>".$this->detail);
                                        } ?>
                                </p>
                            ...
                            <div class="box-body">
                                <input type="hidden" name="adviser" id="adviser" value="<?php if(isset($this->person_id)){ echo($this->person_id); } ?>">
                                <div class="form-group">
                                    <label for="show_academic">Add Adviser to </label>
                                    <select class="form-control" name="entry_class" id="entry_class">


                                        <?php foreach ($this->class as $class){  ?>
                                            <option value="<?php echo $class['class_id']; ?>" <?php if (Session::flash('entry_class') == $class['class_id'] ){echo "selected=\"selected\"";} ?> ><?php echo $class['class_name'] ; ?></option>
