...
function updatePost(update){
    ...
    var use_previous_image = _("use_previous_image").value;
    var previous_image = _("previous_image").value;
    ...
    formdata.append("use_previous_image", use_previous_image);
    ...
    if (update === undefined) {
        ...
        alert('Work has been saved successfully!');
    }
