...
<div class="content-wrapper">
    ...
    <section class="invoice">
        ...
        <div class="row no-print">
            <div class="col-xs-12">
                <a href="<?php echo(URL.'teacher/print_annual/'.$this->url); ?>" target="_blank" class="btn btn-default"><i class="fa fa-print"></i> Print</a>
                ...
                <a href="<?php echo(URL.'teacher/generate_annual_pdf/'.$this->url); ?>" target="_blank" class="btn btn-primary pull-right" style="margin-right: 5px;"><i class="fa fa-download"></i> Generate PDF </a>
