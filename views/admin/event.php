                                ...
                                <h3 class="box-title">Showing all
                                    <?php
                                        if(isset($this->headers)){
                                            echo($this->headers['session_name'].' '.$this->headers['term'].' Term Academic Calendar');
                                        }
                                    ?>
                                </h3>
                            </div>
                                    ...
                                    <?php
                                        foreach($this->about as $mod){
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="<?php echo URL; ?>admin/event/update/<?php echo $mod['id']; ?>" class="btn btn-success btn-flat">Update</a></td>

                                                <td><a href="<?php echo URL; ?>admin/event/delete/<?php echo $mod['id']; ?>" onclick="return confirm('This will be permanently deleted. It cannot be undone. PROCEED?')" class="btn btn-danger btn-flat">Delete </a></td>
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Year/ Term to view</h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form role="form" action="<?php echo(URL.'admin/event'); ?>" method="post" id="contact_form">
                            <div class="box-body">
                                <div class="form-group">
                                    <label for="entry_class">Select Academic Year/ Term*</label>
                ...
                <div class="col-md-9 col-sm-12 col-xs-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form action="<?php echo(URL.'admin/add_event'); ?>" method="post" id="contact_form" enctype="multipart/form-data">
                            <input type="hidden" name="token" value="<?php echo Token::generate(); ?>" />

                            <div class="box-body">
                                <div class="form-group">
                                    <label for="show_academic">Add event to </label>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="title" id="title" value=" <?php if (Session::exists('title')){ echo(Session::flash('title')); } ?>">
                                </div>
