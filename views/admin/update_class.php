            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-12 col-xs-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form action="<?php echo(URL.'admin/create_class/'.$mod['class_id']); ?>" method="post">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="parent_class" id="parent_class">
                                        ...
                                        <?php foreach ($this->class as $class){ if($class['parent_class'] == null){ ?>
                                            <option value="<?php echo $class['class_name']; ?>" <?php if ($mod['class_id'] == $class['class_id'] ){echo "selected=\"selected\"";} ?> ><?php echo $class['class_name'] ; ?></option>
                                ...
                                <!--
                                    ...
                                    <p>Visible:
                                        <label>
                                            <input name="visible" type="radio" id="visible_0" value="0" <?php //if ($mod['visible'] == 0 || Session::flash('visible') === 0){ echo("checked=\"checked\""); } ?> />
                                            No</label>
                                        &nbsp;
                                        <label>
                                            <input type="radio" name="visible" value="1" id="visible_1" <?php //if ($mod['visible'] == 1 || Session::flash('visible') === 1){ echo("checked=\"checked\""); } ?> />
                                            Yes</label>
                                    </p>
