        ...
        <section class="content">
                                    ...
                                    <?php
                                        ...
                                        foreach($this->class as $mod){
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="<?php echo URL; ?>admin/classes/update/<?php echo $mod['class_id']; ?>" class="btn btn-success btn-flat">Update</a></td>

                                                <td><a href="<?php echo URL; ?>admin/view/advisers/<?php echo $mod['class_id']; ?>" class="btn btn-info btn-flat">View Advisers</a></td>
            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-12 col-xs-12">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"> Classroom Center</h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form action="<?php echo(URL.'admin/create_class'); ?>" method="post" id="contact_form" enctype="multipart/form-data">
