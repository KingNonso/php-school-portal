...
?>
    ...
    <section class="content-header">
        <h1>
            <?php echo Session::get('academic_class_name'); ?> Subjects
                                ...
                                if(isset($this->subject)){
                                    foreach($this->subject as $mod){
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $mod['subject_alias'];  ?></td>
                ...
                <form action="<?php echo(URL.'teacher/create_subject'); ?>" method="post" id="contact_form" enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <p class="form-control-static"> <?php echo Session::get('academic_class_name'); ?></p>

                            <input type="hidden" name="subject_for" id="subject_for" value=" <?php echo Session::get('academic_class_id'); ?>" />
