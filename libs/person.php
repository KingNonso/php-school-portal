...
class Person {
    ...
    protected $_sponsor_name;
    protected $_next_of_kin_name;
    protected $_next_of_kin_address;
    protected $_next_of_kin_phone;
    protected $_next_of_kin_occupation;
    protected $_next_of_kin_relationshipType;

    public static $instruction = 'Instruction: Hostel A is only for girls, while Hostel B males occupy rooms 100 - 300 and girls occupy 301 - 400';
