    ...
    if(isset($this->subject)){
                                        foreach($this->subject as $mod){
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="<?php echo URL; ?>admin/subject/update/<?php echo $mod['subject_id']; ?>" class="btn btn-success btn-flat">Update</a></td>
                                                <td><a href="<?php echo URL; ?>admin/view/teachers/<?php echo $mod['subject_id']; ?>" class="btn btn-info btn-flat">View Teachers</a></td>
            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-12 col-xs-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form action="<?php echo(URL.'admin/create_subject'); ?>" method="post" id="contact_form" enctype="multipart/form-data">
