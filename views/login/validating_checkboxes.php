                ...
                <div class="row">
                    <div class="col-sm-12 form-group">
                        <div class="input-group">
                            ...
                            <input type="email" id="email" name="email" class="form-control" placeholder="Enter Email address" required value="achinonso@gmail.com">
                        </div>
                    ...
                    <div class="col-sm-12 form-group">
                        <div class="input-group">
                            ...
                            <input type="password" id="password"  name="password"  class="form-control" placeholder="Enter Password: " required value="achinonso@gmail.com">
                        </div>
