...
<div class="row">
    <div class="col-sm-12">
        ...
        <div class="panel panel-primary">
                    ...
                    <div class="box-body">
                        <div class="form-group has-success">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" id="title" name="title" value="<?php echo($blog['post_title'])  ?>" placeholder="Enter Post Title Here...">
                        ...
                        <div style="display: none" id="sub_holder" class="form-group">
                            <div class="input-group" >
                                ...
                                <input type="text" class="form-control" placeholder="Enter subtitle here..." value="<?php echo($blog['subtitle'])  ?>" name="subtitle" id="subtitle">
                            </div>
                        </div>

                        <input type="hidden" name="token" id="token" value="<?php echo $blog['guide']; ?>" />

                        <div class="form-group">
                            <label class="control-label" for="slug">Slug</label>
                            <div class="input-group">
                                <span class="input-group-addon">www.winnersfamily.com/blog/title/<?php echo($blog['slug_date']); ?>/</span>
                                <input type="text" class="form-control" placeholder="Automatically generated Title slug..." name="slug" id="slug" value="<?php echo($blog['slug_title']); ?>">
                                <input type="hidden" id="slug_date" value="<?php echo($blog['slug_date']); ?>">
                            </div>
                        ...
                        <div class="form-group has-success">
                            <label>Post</label>
                            <textarea class="form-control" rows="18" placeholder="Enter Message here ..." id="post" name="post">
                            ...
                            <div class="row">
                                <div class="imageupload panel panel-default">
                                    <div class="panel-heading clearfix">
                                        <h3 class="panel-title pull-left"> Featured Image</h3>
                                        <div class="btn-group pull-right">
                                            <button type="button" class="btn btn-default active">File</button>
                                            <button type="button" class="btn btn-default">URL</button>
                                        </div>
                                    </div>
                                    <input type="hidden" name="use_previous_image" id="use_previous_image" value="yes" />
                                    <?php if (!empty($blog['featured_image'])){ ?>
                                        <div id="previous-choice">
                                            <input type="hidden" name="previous_image" id="previous_image" value="<?php echo($blog['featured_image']); ?>" />

                                            <h4>Previously used image</h4>
                                ...
                                <select id="category" name="category" class="form-control">
                                    <?php
                                        foreach($this->category as $cat){
                                            ...
                                            <option value="<?php echo $cat['cat_id']; ?>" <?php if($cat['cat_id'] == $blog['category']){echo 'selected="selected"'; } ?> ><?php echo $cat['cat_name']; ?></option>
                                        <?php }  ?>                              </select>
                                <br/>
                                            ...
                                            <select class="form-control select2" multiple="multiple" data-placeholder="Start typing here..." style="width: 100%;" id="used_tags">
                                                ...
                                                <?php
                                                    ...
                                                    foreach($this->tags as $tag){
                                                        ...
                                                        <option value="<?php echo $tag['tag_id']; ?>" <?php for($x = 0; $x<$i; $x++){ if($tag['tag_id'] == $tags[$x]){echo 'selected="selected"'; }} ?> ><?php echo $tag['tag_name']; ?></option>
                                                    <?php }  ?>                              </select>
                                        </div>
            ...
            <div class="panel-heading">
                <button type="submit" id="submit" class="btn btn-default btn-lg" onclick="updatePost()">Publish Immediately</button>
                <button onclick="updatePost(1)" class="btn btn-info pull-right">Save as Draft</button>
            </div>
        </div>
        </form>
