...
<div id="homecontent" class="container-fluid ">
    <div class="row" id="container">
        ...
        <div class="col-sm-7">
            <div>
                <form id="form1" name="form1" method="post" action="<?php echo URL; ?>links/web_access"  enctype="multipart/form-data">
                    <h1>Create a Staff Login</h1>
                    ...
                    <input type="hidden" name="owner_is" id="owner_is" value="3" />
                    ...
                    <div class="row">
                        <div class="col-sm-12" id="login_submit">
                            <input class="btn btn-primary btn-lg" type="submit" name="send" id="send" value="Submit &amp; Start" />
                        </div>
                    </div>
                    <br />
