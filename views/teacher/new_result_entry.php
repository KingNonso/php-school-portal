...
?>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h2>
                Create a New/ View Result Entry
            </h2>
            <div class="box-body">
            ...
            <div class="row">
                ...
                <div class="col-sm-7 col-sm-offset-3 ">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form action="<?php echo(URL.'teacher/start_record'); ?>" method="post" id="contact_form" enctype="multipart/form-data">
                                    ...
                                    <?php if(($this->using) == 'class'){  ?>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" name="select_class" id="select_class" value="<?php echo $this->using_id ; ?>">
                                    ...
                                    <?php }else{ ?>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" name="select_subject" id="select_subject" value="<?php echo $this->using_id ; ?>">
